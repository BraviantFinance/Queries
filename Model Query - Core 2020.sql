...
select
    ...
    ,case
        ...
        when a.state_code in ('KS', 'TN') then 'LOC'
        when a.state_code not in ('CA', 'KS', 'TN') then 'Core' end as product
...
where
    ...
    and (a.state_code <> 'CA' or a.state_code <> 'KS' or a.state_code <> 'TN')
);
...
create temporary table core_table as (
  select a.app_month
       , a.funding_month
       , a.cust_type
       , a.product
